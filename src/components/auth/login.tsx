...
export default function SignUp() {
    ...
    return (
        <section className='w-full flex justify-center p-[2rem] min-h-[100vh]'>
            <div className='flex flex-col items-center w-[350px] h-[510px] rounded-3xl border-[#2A303C] border p-[1.2rem]'>
                ...
                <form action="" method="POST" className="flex flex-col items-center gap-3 w-full">
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <div>
                        <input type="password" ref={password} placeholder="Password" className="input input-bordered w-full max-w-xs" />
