...
export default function PostForm() {
  ...
  useEffect(() => {
    if (watchedUrl) {
      ...
      if (postFile) {
        if (isImage(postFile.name))
          setImagePreview(URL.createObjectURL(postFile));
        if (isVideo(postFile.name))
          setVideoPreview(URL.createObjectURL(postFile));
      }
    } else {
  ...
  return (
    <div>
      ...
      <div className="modal">
        <div className="modal-box min-w-[320px]">
          <form
            action=""
            method="post"
          ...
          >
            <div className="flex flex-col gap-5">
              ...
              <div className="card card-compact w-[315px] sm:w-96 bg-base-100 shadow-xl">
                {imagePreview && (
                  <figure>
                ...
                {!(imagePreview || videoPreview) && (
                  <div className="h-[300px] w-[315px] sm:w-[384px] flex justify-center items-center">
                    <label htmlFor="file" className="text-[5rem] text-center">
                      +
                    </label>
                  </div>
                )}
